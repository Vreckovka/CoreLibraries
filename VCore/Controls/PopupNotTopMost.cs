...
namespace VCore.WPF.Controls
{
  public class NonTopmostPopup : Popup
  {
    ...
    public NonTopmostPopup()
    {
      ...
      Closed += NonTopmostPopup_Closed;
      StaysOpen = true;
    }

    private void NonTopmostPopup_Closed(object sender, EventArgs e)
    {
    }

    private bool isForcedHide;
    ...
    private void _parentWindow_Loaded(object sender, RoutedEventArgs e)
    {
    }
    ...
    private void SetTopmostState(bool isTop)
    {
      ...
      if (isTop && !FullScreenManager.IsFullscreen)
      {
